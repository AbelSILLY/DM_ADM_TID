...
#  gradient_values=seq(0, 1, length.out = 100)
#  gradient_colors=palette(length(gradient_values))
#  Plotj=plot(x,Quan[,j], col=gradient_colors[j])
#}
```

```{r}
W=diag(1/21, 21) # matrice des poids
I_11=diag(1, 21) #matrice identité de taille 11
Quan=WINE[,4:32]
